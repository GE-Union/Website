...
<h2
id={"int-part-tickets"}
className={`w-element c1l00ka2 csmduke c5r3npr c8qj03j c6f08mx cyoo8jj c14xzzjo cxa4mkp cy2vnym cicj15w`}>
{"Buy a ticket for the "}
<b
className={`w-element c96o7df`}>
{"International party"}
</b>
{" here!"}
</h2>
