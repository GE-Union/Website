import{j as e,U as s,n as a,g as n,y as o,T as g,C as x,P as y,O as f,x as v,a as k,M as j,R as b,S as q,$ as z,b as N,r as m,c as i,i as d,d as C,e as E,f as _,h as S,k as P}from"../chunks/chunk-LfFDiz3d.js";/* empty css                      */const p="GE Union",T=[{id:"2EiFMEG40PBm9_fkelqpo"},{id:"xOnFYyuZv5VkMeeKDLyiu",maxWidth:991},{id:"Uvcw_OJqyPoLioZzUbP1x",maxWidth:767},{id:"eCbcXJaLEKSKcnbAPzNF0",maxWidth:479}],A="Favicon_gtxnE_QXZldwugdMJXAuG.ico",I=[],D=[],L=c=>e.jsxs("body",{className:"w-element c1lzvaoj ci03eyw cu8ogtt c1nj86ny cm1ds2c",children:[e.jsx(s,{code:`<style>
...
@import url('https://api.fontshare.com/v2/css?f[]=tanker@400&amp;display=swap');
  ...
  if (typeof window.Intro_QA_JSON_URL === 'undefined') {
    window.Intro_QA_JSON_URL = "https://raw.githubusercontent.com/GE-Union/WebsiteContent/main/Introduction/QnA.json";
  }
  if (typeof window.Intro_QA_CACHE_KEY === 'undefined') {
    window.Intro_QA_CACHE_KEY = "coursebank_structure_cache";
  }
  ...
  async function fetchQnA() {
    // try cache
    const raw = localStorage.getItem(Intro_QA_CACHE_KEY);
    if (raw) {
    ...
    // otherwise re-fetch
    const res = await fetch(Intro_QA_JSON_URL, { cache: "no-store" });
...
<\/script>`,executeScriptOnCanvas:!0,className:"w-html-embed"})]}),O=c=>{const{origin:t,pathname:l,search:r}=new URL(c);return`${t}${l}${r}`},M=m.memo(({pageKey:c,system:t})=>e.jsx(L,{system:t},c),(c,t)=>c.pageKey===t.pageKey),U=({data:c})=>{const{system:t,resources:l,url:r,pageMeta:h}=c,u=O(r),w=m.useMemo(()=>({imageLoader:d,assetBaseUrl:i,resources:l,breakpoints:T,onError:console.error}),[l]);return e.jsxs(C.Provider,{value:w,children:[e.jsx(E.Provider,{value:r,children:e.jsx(M,{pageKey:u,system:t})}),e.jsx(_,{url:r,pageMeta:h,siteName:p,imageLoader:d,assetBaseUrl:i}),e.jsx(S,{children:h.title})]})},B=Object.freeze(Object.defineProperty({__proto__:null,default:U},Symbol.toStringTag,{value:"Module"})),F=({})=>{const c={"@context":"https://schema.org","@type":"WebSite",name:p};return e.jsxs(e.Fragment,{children:[e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(c,null,2)}}),e.jsx("link",{rel:"icon",href:d({src:`${i}${A}`})}),I.map(t=>e.jsx("link",{rel:"preload",href:`${i}${t}`,as:"font",crossOrigin:"anonymous"},t)),D.map(t=>e.jsx("link",{rel:"preload",href:`${i}${t}`,as:"image"},t))]})},H=Object.freeze(Object.defineProperty({__proto__:null,Head:F},Symbol.toStringTag,{value:"Module"})),K={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"/renderer/+onRenderClient.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:P}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/introduction/+Page.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:B}},Head:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/introduction/+Head.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:H}}};export{K as configValuesSerialized};
